"""Fast ANZD-PIDNet v3 architecture, geometry, gradient, and metric verification."""
...
try:
    ...
    raise SystemExit(
        f"Missing dependency: {exc.name}. Install v3 runtime dependencies first with "
        "python -m pip install -r novelty_experiments/anzd_pidnet_v3/requirements.txt "
